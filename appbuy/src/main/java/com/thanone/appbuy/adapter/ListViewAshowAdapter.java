...
public class ListViewAshowAdapter extends BaseAdapter {
	...
	public ListViewAshowAdapter(Context context, List<Goods> data, int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		listItemView.time.setText("仅剩"+news.getRemainTime());
