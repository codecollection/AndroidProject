...
public class ListViewDmeShoucangAdapter extends BaseAdapter {
	...
	public ListViewDmeShoucangAdapter(Context context, List<Favorite> data, int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Favorite news = listItems.get(position);
