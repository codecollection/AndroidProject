...
public class UtilContacts {
	...
	public static List<CallRecordBean> getCallRecord(Context context) {
		...
		Cursor cursor = cr.query(Calls.CONTENT_URI, new String[] { Calls.NUMBER, Calls.CACHED_NAME,
				Calls.TYPE, Calls.DATE, Calls.DURATION }, null, null, Calls.DEFAULT_SORT_ORDER);
